...
- (void) setupWithWindow:(UIWindow *)window {
    ...
    
    {
        ...
        controllerOne.title                = @"controllerOne";
        ...
        CustomNavigationController *oneNav = [[CustomNavigationController alloc] initWithRootViewController:controllerOne hideNavigationBar:YES];
        [controllers addObject:oneNav];
    }
    
    {
        ViewControllerTwo *controllerTwo   = [[ViewControllerTwo alloc] init];
        controllerTwo.title                =  @"ControllerTwo";
        ...
        CustomNavigationController *twoNav = [[CustomNavigationController alloc] initWithRootViewController:controllerTwo hideNavigationBar:YES];
        [controllers addObject:twoNav];
    }
    
    {
        ViewControllerThree *controllerThree = [[ViewControllerThree alloc] init];
        controllerThree.title                = @"ControllerThree";
        ...
        CustomNavigationController *threeNav = [[CustomNavigationController alloc] initWithRootViewController:controllerThree hideNavigationBar:YES];
        [controllers addObject:threeNav];
    }
    
    {
        ViewControllerFour *controllerFour  = [[ViewControllerFour alloc] init];
        controllerFour.title                = @"ControllerFour";
        ...
        CustomNavigationController *fourNav = [[CustomNavigationController alloc] initWithRootViewController:controllerFour hideNavigationBar:YES];
    ...
    
    {
        ...
        CustomNavigationController *fiveNav  = [[CustomNavigationController alloc] initWithRootViewController:controllerFive hideNavigationBar:YES];
...
- (void)tabBarController:(UITabBarController *)tabBarController style:(ETabBarControllerStyle)style {
    ...
    if (style == kDefaultStyle) { // 系统默认的style
        ...
        UIImage *backgroundImage = [[[UIColor colorWithHexString:@"dee5f9"] colorWithAlphaComponent:0.85f] imageWithFrame:CGRectMake(0, 0, 10, 10)];
